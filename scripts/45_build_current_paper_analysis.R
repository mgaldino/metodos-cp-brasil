...
denominator_summary <- tibble::tibble(
  denominator = c(
    ...
    "Artigos dos periódicos completos em que a identificação é especialmente relevante",
    "Artigos dos periódicos completos com estratégia explícita de identificação causal",
  ...
  n = c(
    ...
    complete_metrics$n_screen,
    complete_metrics$n_strict,
  ...
  denominator_reference = c(
    ...
    "artigos dos periódicos completos",
    "casos relevantes para identificação nos periódicos completos",
    "artigos classificados",
    "artigos empíricos classificados",
    "artigos empíricos quantitativos classificados",
    "artigos empíricos quantitativos classificados",
  ...
  percent = c(
    ...
    complete_metrics$pct_screen,
    complete_metrics$pct_strict,
